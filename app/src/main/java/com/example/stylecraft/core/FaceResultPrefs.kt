...
object FaceResultPrefs {
    ...
    fun genderFlow(context: Context): Flow<String?> =
        context.dataStore.data.map { prefs -> prefs[KEY_GENDER] ?: "Female" }

    suspend fun saveFaceShape(context: Context, faceShape: String, confidence: Float = 0.9f, gender: String = "Female") {
